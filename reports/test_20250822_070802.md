...
| openshift-marketplace | 🟢 16 | 5 | 0 | 1 | 5 | 1 |
...
- community-operators-2zgzz (openshift-marketplace)
...
- Pod community-operators-2zgzz en namespace openshift-marketplace tiene problemas
...
**New Problems**: 
- Pod con problemas: faulty-app-6bbbcbc6d7-6j84d (chaos-test)
- Pod con problemas: community-operators-2zgzz (openshift-marketplace)
- Pod con problemas: faulty-app-6bbbcbc6d7-926qn (chaos-test)
- Pod con problemas: faulty-app-6bbbcbc6d7-xbfrt (chaos-test)
